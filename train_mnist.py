...
def train_rbm(model_name, hidden, cdk, lr, momentum, decay, epochs):
...
parser.add_argument('--decay', type=float, default=1e-7, help='weight decay')
parser.add_argument('--epochs', type=int, default=30, help='number of training epochs')
args = parser.parse_args()

train_rbm(args.model_name, args.hidden, args.cdk, args.lr, args.momentum, args.decay, args.epochs)